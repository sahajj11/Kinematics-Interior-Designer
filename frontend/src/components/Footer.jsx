      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 pb-20 border-b border-gray-100">
          ...
          <div className="flex flex-col gap-6">
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-black-400">HQ — Dubai</span>
            <p className="text-sm text-black-600 leading-loose font-light">
          ...
          <div className="flex flex-col gap-6">
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-black-400">Follow</span>
            <ul className="text-sm text-black-600 space-y-3 font-light">
          ...
          {/* Navigation Section */}
          <div className="flex flex-col gap-6">
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-black">Navigate</span>
            <ul className="text-sm text-black-600 space-y-3 font-light">
          ...
          <div className="flex flex-col gap-6">
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-black-400">Newsletter</span>
            <div className="relative border-b border-black/10 pb-2">
              <input 
                type="email" 
                placeholder="YOUR EMAIL" 
                className="bg-transparent w-full text-[10px] tracking-[0.2em] outline-none placeholder:text-black-400 uppercase py-2"
              />
        ...
        <div className="pt-12 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-6">
            ...
            <span className="text-[9px] uppercase tracking-[0.6em] text-black-300">
              © 2026 Crafted in Dubai
            </span>
          </div>
          
          <div className="flex gap-12 text-[9px] uppercase tracking-[0.4em] text-black">
