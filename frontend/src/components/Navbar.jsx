  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed top-0 w-full z-[100] px-6 md:px-16 transition-all duration-500 ${
          isScrolled || isOpen
      ...
      >
        <div className="max-w-[1400px] mx-auto flex justify-between items-center">
          ...
          <div className="flex flex-col group cursor-pointer z-[110]">
            <span className={`text-2xl font-serif tracking-[0.2em] uppercase transition-colors duration-500 ${isScrolled || isOpen ? "text-black" : "text-white"}`}>
              Kinematics
            </span>
            <span className={`text-[8px] tracking-[0.5em] uppercase font-bold transition-colors duration-500 ${isScrolled || isOpen ? "text-gray-400" : "text-white/60"}`}>
              Interior Designer
            </span>
          </div>
